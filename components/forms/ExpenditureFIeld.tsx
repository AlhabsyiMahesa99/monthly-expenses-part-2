...
const ExpenditureField: React.FC<Props> = ({ filters }) => {
  ...
  return (
    <div className="bg-white p-5 rounded-xl shadow-sm w-full">
      <h2 className="font-bold text-lg mb-3">Pengeluaran</h2>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-y-2 border-black">
              ...
              <th className="py-3 text-left font-semibold">Nama Penjual</th>
...
export default ExpenditureField;